...
describe User do
  ...
  it "should accept valid email addresses" do
    ...
    it "should reject email adresses identical up to a case" do
   ...
   describe "microposts accociations" do
    ...
    it "should destroy accosiated microposts" do
    	...
    	describe "status feed" do
    	  ...
    	  it "should include the microposts of other users" do
    	...
    	describe "relationships" do
                ...
                it "should include the following user in the followed array" do
                        @user.follow!(@followed)
                ...
                it "should include the followers in the following array" do
                        @user.follow!(@followed)
